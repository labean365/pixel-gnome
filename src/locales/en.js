...
export default {
  ...
  card: {
    ...
    pdfAria: 'PDF: {name}',
    pdfBadge: '{count}p',
    pdfPages: { one: '{count} page', other: '{count} pages' },
    pdfPagesLoading: 'Reading…',
    pdfThumbAlt: 'PDF first page preview',
    editPages: 'Edit pages',
    editPagesTitle: 'Edit PDF pages',
